...
const StoryPage = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#d2def4]">
      <div className="container mt-20 flex w-full flex-grow flex-col gap-6">
        <h2
          className={cn(
            luckiest_guy.className,
            "items-center bg-gradient-to-b from-[#fdfe28] from-10% via-[#ffa136] via-40% to-[#f66708] to-80% bg-clip-text text-start text-5xl text-transparent",
            "drop-shadow-[0px_5px_0px_rgba(114,4,165,1)]",
          )}
        >
          Story
        </h2>
        <div className="flex flex-grow flex-col gap-8 text-[#1d1d1c]">
          <p>
          ...
          <p>
            Suatu malam, dalam perjalanannya melewati hutan yang lebat, Pangeran
            Djoyo tersesat dan ia mendengar sayup-sayup suara yang memanggil
            namanya, "Djoyo... Djoyo... Djoyo..." karena penasaran, Pangeran
            Djoyo mengikutinya hingga tiba di depan sebuah gua.
          </p>
          <p>
            Hujan mulai turun, lalu Djoyo memutuskan untuk berteduh di dalam gua
            tersebut, karena gelap dan licin, Djoyo tak sengaja tergelincir dan
          ...
          <p>
            ...
            dengan pohon-pohon yang menjulang tinggi ke langit. Di sana terdapat
            kolam dengan sumber air berwarna hijau, serta sistem cuaca yang
          ...
          <p>
            ...
            hutan pohon lemon. Ia memutuskan untuk beristirahat di sana, sambil
            menikmati buah lemon segar yang menyelamatkannya dari rasa lapar dan
          ...
          <p>
            ...
            tanam dan menjaga hutan lemon dari serangan kera dan kelelawar yang
          ...
          <p>
            Pada suatu malam, Kakek Djoyo tertidur lelap dan bermimpi. di dalam
            mimpinya ia melihat 6 topengnya hidup dan menjelma menjadi karakter
